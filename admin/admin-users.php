  ...
  <div class="modal-dialog modal-dialog-centered mw-100 w-50">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"  id="getName"> User's Details </h4>
        ...
        success: function(response){
           ...
           data = JSON.parse(response);
             ...
             if(data.photo != ''){
                ...
                $("#getImage").html('<img src="../assets/img/defaultprofile.png" class="img-thumbnail img-fluid, align-self-center" width="280px" >');
